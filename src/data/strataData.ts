...
export interface StrataDatabase {
  meta: {
  ...
  globalAudit: GlobalAuditRecord[];
}

export const INITIAL_STRATA_DATA: StrataDatabase = {
  meta: {
    currentUser: {
      name: "S. K. Mukherjee",
  ...
  inspections: [
    ...
    },
    {
      ...
      activity: [
        { time: "2026-07-25", user: "K. Sen", action: "Final statutory report approved and published" }
      ]
    }
  ],
